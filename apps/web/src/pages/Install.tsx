              ...
              },
              {
                ...
                content: (
                  <>
                    <Cmd text="eat sync" />
                    <span>
                      Skill 落地 ~/.agents/skills 并软链到 ~/.claude/skills；内置的「eat 平台使用指南」会一起同步，让 AI
                      认识平台能力。
                    </span>
                  </>
                ),
      ...
      <Card>
        <CardContent>
          ...
          <p className="mb-4 text-sm leading-relaxed text-muted-foreground">
            ...
            安装与登录；MCP 复用 CLI 凭证（<InlineCode>~/.eat/credentials</InlineCode>），无需再登录。
          </p>
          <div className="mb-2 text-sm font-medium">Claude Code：</div>
          <Cmd text="claude mcp add --scope user eat -- eat mcp" />
          <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
            若 eat 不在 PATH，把命令换成 <InlineCode>~/.eat/bin/eat</InlineCode> 的完整路径。 其他 MCP
